...
% (this does not work, as findobj cannot search through a property array:
% lane = findobj(lanes, 'lanelets', lanelet))
...
for i = 1:numel(obj)
    ...
    if ~isempty(findobj(obj(i).lanelets, 'id', lanelet.id))
        lane(end+1) = obj(i);
    end
end
